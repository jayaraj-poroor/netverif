 ...
 */
public
class ServerSocket extends java.net.ServerSocket{
    /**
     ...
     */
    private NetVerifSocketImpl impl;
    ...
    protected final void implAccept(Socket s) throws IOException {
        ...
        try {
            ...
            si = s.impl;
            s.impl = null;
            si.setFields(InetAddress.getLocalHost(), new FileDescriptor());
            getImpl().accept(si);
